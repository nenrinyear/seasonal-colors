/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: f2d2f686f7b8f8d640322a98d1288600)
// Runtime types generated with workerd@1.20250428.0 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		seasonal_colors: KVNamespace;
		NEXTJS_ENV: string;
		ASSETS: Fetcher;
	}
}
